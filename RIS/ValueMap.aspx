<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ValueMap.aspx.vb" Inherits="RIS.ValueMap" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    position: relative;
              ...
              .pnlscore .slider-container{
                  width:600px!important;
                  margin-left:85px;
              }
                .pnlscore .slider-container .back-bar {
                    background-color: #5ADDBE !important;
                }
               .pnlscore  .theme-green .back-bar {
            background-image:linear-gradient(to bottom, #5ADDBE, #5ADDBE) !important;
        }
        .pnlscore .slider-container .back-bar .selected-bar {
             /*background-color: #5ADDBE;*/
              background-color: red;
        }
        .pnlscore .slider-container .back-bar .low {
             display:none;
        }
         .pnlscore .slider-container .back-bar .high {
             display:none;
        }
    </style>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" ClientIDMode="Static">
    ...
    <asp:HiddenField ID="hidVMOCustomerUrl" runat="server" />
    <%-- <div class="row">--%>
    ...
    <div class="right" id='maincontent'>
        ...
        <div class="row queries my-3">
            ...
            <div class='col-md-5' style="padding: 10px;">
               <button class="btn float-right align-text-bottom font-weight-bold px-3" style="" id="btnVmReview" runat="server" type="button">&nbsp;Finish VM&nbsp;</button>&nbsp;&nbsp;
            </div>
        </div>
        <div  class="row" id="divValueGapTitle" runat="server">
            <div class="col-md-6">
                 <h6 class="float-left" id="btnValueGapTitle" style="font-size:12px; cursor:pointer; margin-left:5px;" >What's This?</h6> 
            </div>
             <div class="col-md-6">
                  <h6 class="" style="font-size:12px; cursor:pointer;" ><a class="float-right " style="font-size:12px; display:none;cursor:pointer;" id="create_pdf" runat="server" >Print Value Map</a></h6> 
            </div>
            <br />
        </div>
       
        <div class="row" id="divValueGapContent" runat="server" style="display:none;">
            <div class="col-md-12" style="margin-left: 5px;">
            <div class="row " id="divValueGap"  runat="server">
                
                    <div class="col-md-12 valuemap box">
                        <asp:Panel ID="pnlScore" runat="server" CssClass="pnlscore" style="margin-bottom:-25px;">
                                            <div>
                                                <h2 style="padding: 0px 0px 5px 0px !important; font-size: 15px !important; font-weight: bold;" class="text-center">VALUE GAP SCORE  =  <asp:Label ID="lblValueGap" runat="server" Font-Size="15px" Font-Bold="true"></asp:Label></h2> 
                                            </div>
                                            <input class="range-slider" type="hidden" runat="server" id="txtScore" /><br />
                                            <div  >
                                                <h2 style="padding: 0px 0px 5px 0px !important; font-size: 12px !important; font-weight: normal; margin-top:20px;" class="text-center">Probability of Purchasing:  <asp:Label ID="lblValueGapProbability" runat="server" Font-Size="12px" ForeColor="#5addbe" Font-Bold="true">Very Likely</asp:Label></h2>
          ...
          <h6 style="display:none;"><span id="lblValueMapTitle" runat="server">Value Map:</span><br/></h6>
        
        <div class="row">
            
            <div class="col-md-12" >
                <div class='row' id="divPriorityOverView" runat="server" style="margin-left: 5px;">
                    <div class='col-12 valuemap box'>
                          <div class="row font-weight-bold" id="divPrintCustomerInfo" style="display:none; font-size:12px;">
 <div class="col-md-12 text-center " style="font-size:24px" >Personal Value Map Created For:&nbsp; <asp:Label ID="lblPrintCustomerName" runat="server" Font-Size="20px">Customer Name</asp:Label></div>
                    <div class="col-md-12 text-center " >With:&nbsp; <asp:Label ID="lblPrintUserName" runat="server">User Name</asp:Label></div>
                    <div class="col-md-12 text-center " ><asp:Label ID="lblPrintUserPhoneNumber" runat="server">User Phone Number</asp:Label></div>
                    </div>
                        <div class='row'>
                            <div class='col col1'>
  ...
  justify-content: center;">
    ...
    <div id="valueGapModal" class="modal fade" role="dialog" >
  <div class="modal-dialog">
    <!-- Modal content-->
    <div class="modal-content" >
      ...
      <div class="modal-body" style="padding-top:0px; padding-bottom:0px;">
        <div class="row">
            ...
            <div class="col-md-12" >
            <span id="lbltitleMessage">0 to 15 Not Likely <br />15 to 16 Possible <br />16 to 17 Likely<br />18 to 20 Very Likely</span>
        </div>
      </div>
         <div class="modal-footer" style="border-top:none; padding:0px">
             <div class="col-md-4"></div>
                                    <div class='col-md-8'>
                                        <button type="button" style="display:none;" class="btn float-right my-4 font-weight-bold" data-dismiss="modal">Cancel</button>
                                        <button type="button" class="btn float-right my-4 font-weight-bold" style="margin-right:10px;" data-dismiss="modal" id="btnValueGapOk">OK</button>
  ...
  <div class="modal-dialog">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#btnNextRank").click(function () {
                ...
                $("#hidPriority").val(priority);
                //  BindPriorityName();if (currentPriority == 2) {
        ...
        function BindAnswer(questionTypeId, lblId) {
            ...
            $.ajax({
                url: "ValueMap.aspx/GetValueMapChoicesByQuestionId",
                type: "POST",
                dataType: "json",
                data: dataValue,
    ...
    <script type="text/javascript">
        ...
        function InsertCustomerPriorityChoices() {
            ...
            $.ajax({
                url: "ValueMap.aspx/InsertCustomerPriorityChoices",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function UpdateCustomerPriorityChoiceRank() {
            var dataValue = '{CustId: "' + $("#hidCustId").val() + '", Priority: "' + $("#hidPriority").val() + '"}';
            $.ajax({
                url: "ValueMap.aspx/UpdateCustomerPriorityChoiceRank",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function AddOtherItem() {
            ...
            if (divId == "divEditModalContentBenefit") {
             ...
             if (divId == "divEditModalContentImpact") {
                var minHeight = $("#divEditModalContent" ).find(".btns").first().css("min-Height");
                var minWidth = $("#divEditModalContent").find(".btns").first().outerWidth().toString().replace("px", "") + "px";
                 $("#divEditModalContent").find(".btns").last().before("<div class='col-md-4 btns' style='min-height:"+minHeight+";' ><button type='button' class='btn-default active' id='" + $("#txtOther").val() + "'>" + $("#txtOther").val() + "</button> </div>");
                FutureEditButtonClick("divEditModalContentImpact");
            }
        ...
        function GetCSIdeal() {
            ...
            $.ajax({
                url: "ValueMap.aspx/GetCustomerPriorityIdeal",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function InsertCustomerPriorityChoiceDetails(custId, priorityId, questionType, answer,wwdc) {
            ...
            $.ajax({
                url: "ValueMap.aspx/InsertCustomerPriorityChoiceDetails",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function GetCSCurrent(custId, priorityId, questionType) {
            ...
            $.ajax({
                url: "ValueMap.aspx/GetCustomerPriorityCurrent",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function GetCustomerPriorityImpact(custId, priorityId, questionType) {
            var dataValue = '{CustId: "' + custId + '", PriorityId: "' + priorityId + '",QuestionTypeId: "' + questionType + '"}';
            $.ajax({
                url: "ValueMap.aspx/GetCustomerPriorityImpact",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function GetCustomerPriorityBenefit(custId, priorityId, questionType) {
            var dataValue = '{CustId: "' + custId + '", PriorityId: "' + priorityId + '",QuestionTypeId: "' + questionType + '"}';
            $.ajax({
                url: "ValueMap.aspx/GetCustomerPriorityBenefit",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function GetCustomerFuture() {
            ...
            $.ajax({
                url: "ValueMap.aspx/GetCustomerFuture",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function inArray(item,arr)
{
    ...
    return false;
        ...
        function GetSelectedPriorityChoices(custId, priorityId, questionType) {
            ...
            $.ajax({
                url: "ValueMap.aspx/GetCustomerPriorityChoices",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
    ...
    <script type="text/javascript">
        ...
        $(".fsdesc").on("click", function () {
            ...
            $(this).find("p").each(function () {
                list.push($(this).text().toString().replace("1. ","").replace("2. ","").replace("3. ","").replace("4. ",""));
            });
            //  alertDialog(list.length);
            $.ajax({
                url: "ValueMap.aspx/GetCustomerFutureEdit",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
                success: function (msg) {
                    ...
                    var btnArray = new Array();
                            ...
                            for (var i = 0; i < list.length; i++) {
                                if (inArray(list[i], btnArray) == false) {
                                   // alert("future");
                                    var minHeight =$("#divEditModalContent").find(".btns").first().css("min-Height");
                var minWidth = $("#divEditModalContent").find(".btns").first().outerWidth().toString().replace("px", "") + "px";
                                     $("#divEditModalContent").find(".btns").last().before("<div class='col-md-3 btns' ><button type='button' class='btn-default active' id='" + list[i] + "'>" + list[i] + "</button> </div>");
                                }
                            }
                        ...
                        $(this).click(function () {
                            ...
                            if (btnText == "other") {
                                ...
                                if (toggleCount >= 4) {
                                    ...
                                    ShowOtherItemDialog("divEditModalContentFuture");
                                }
                            }
                            else {
                                $(this).toggleClass("active");
        ...
        $(".fsimpact").on("click", function () {
            ...
            $("#" + descId).find("p").each(function () {
                answer = answer + $.trim($(this).text().toString().replace("1. ","").replace("2. ","").replace("3. ","").replace("4. ","")) + ",";
            });
            // answer = answer.replaceAll("!", " ,");
            answer = answer.substr(0, answer.length - 1);
            answer = answer.replace(/,(?=[^,]*$)/, ' and ');
            ...
            //  alertDialog(list.length);
            $.ajax({
                url: "ValueMap.aspx/GetCustomerFutureImpactEdit",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
                            ...
                            for (var i = 0; i < list.length; i++) {
                                if (inArray(list[i], btnArray) == false) {
                                   // alert("future");
                                    var minHeight =$("#divEditModalContent").find(".btns").first().css("min-Height");
                var minWidth = $("#divEditModalContent").find(".btns").first().outerWidth().toString().replace("px", "") + "px";
                                     $("#divEditModalContent").find(".btns").last().before("<div class='col-md-4 btns' ><button type='button' class='btn-default active' id='" + list[i] + "'>" + list[i] + "</button> </div>");
                                }
                            }
                    ToggleDivHover("divEditModalContent");
                    maxHeightPriorityButtons("divEditModalContent");
                        ...
                        $(this).click(function () {
                            ...
                            if (btnText == "other") {
                                ...
                                if (toggleCount >= 4) {
                                    ...
                                    ShowOtherItemDialog("divEditModalContentBenefit");
                                }
                            }
                            else {
                                $(this).toggleClass("active");
        ...
        $(".csimpact").on("click", function () {
            ...
            //  alertDialog(list.length);
            $.ajax({
                url: "ValueMap.aspx/GetCustomerCSImpactEdit",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
                success: function (msg) {
                    // alertDialog(msg.d);
                    $("#divEditModalContent").html("").html(msg.d.split("~")[0]);
                    var wwdc = msg.d.split("~")[1];
                    $("#divEditModalContent,#divEditButtons,#divEditPriorityTitleHead").css("display", "");
                    $("#divPriorityOverView").css("display", "none");
                     ToggleValueGap();
                        ...
                        $(this).click(function () {
                            ...
                            if (btnText == "other") {
                                ...
                                if (toggleCount >= 4) {
                                    ...
                                    ShowOtherItemDialog("divEditModalContentImpact");
                                }
                            }
                            else {
                                $(this).toggleClass("active");
        ...
        $(".csdesc").on("click", function () {
            ...
            //  alertDialog(list.length);
            $.ajax({
                url: "ValueMap.aspx/GetCustomerPriorityCurrentEdit",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
                success: function (msg) {
                    ...
                    if (isFutureExist == true) {
                                                           $("#divCSCurrentChoiceEdit").addClass("blur-div");
                            $("#divCSCurrentChoiceEdit").find(".btn-default").attr("disabled", "disabled").removeClass("active");
                                for (var i = 0; i < list.length; i++) {
                                    if (inArray(list[i], btnArray) == false) {
                                        var btnCount = $("#divCSFutureChoiceEdit").find(".btn-default").length - 1;
                                        if (btnCount % 2 == 0) {
                                            //   alert("hi");
                                            $("#divCSFutureChoiceEdit").find(".btns").last().css("min-width", "100%").css("max-width", "100%")
                                            $("#divCSFutureChoiceEdit").find(".btns").last().prepend("<button type='button' class='btn-default active' id='" + list[i] + "'>" + list[i] + "</button> ");
                                        }
                                        else {
                                            //  alert("hi1");
                                            var minHeight = $("#divCSFutureChoiceEdit").find(".btns").first().css("min-Height");
                                            var minWidth = $("#divCSFutureChoiceEdit").find(".btns").first().css("min-Width");

                                            var firstBtn = $("#divCSFutureChoiceEdit").find(".btns").last().find(".btn-default").first().html();
                                            $("#divCSFutureChoiceEdit").find(".btns").last().find(".btn-default").first().next().remove();
                                            //  var nextBtn=
                                            $("#divCSFutureChoiceEdit").find(".btns").last().append("<button type='button' class='btn-default active' id='" + list[i] + "'>" + list[i] + "</button> ");
                                            $("#divCSFutureChoiceEdit").find(".btns").last().after("<div class='btns' style='min-Height:" + minHeight + "; min-Width:50%;max-Width:50%'><button type='button' class='btn-default' id='" + "Other" + "'>" + "Other" + "</button> </div>");
                                        }
                            ...
                            $("#divCSFutureChoiceEdit").find(".btn-default").attr("disabled", "disabled").removeClass("active");
                                ...
                                for (var i = 0; i < list.length; i++) {
                                    if (inArray(list[i], btnArray) == false) {
                                        var btnCount = $("#divCSCurrentChoiceEdit").find(".btn-default").length - 1;
                                        if (btnCount % 2 == 0) {
                                            //   alert("hi");
                                            $("#divCSCurrentChoiceEdit").find(".btns").last().css("min-width", "100%").css("max-width", "100%")
                                            $("#divCSCurrentChoiceEdit").find(".btns").last().prepend("<button type='button' class='btn-default active' id='" + list[i] + "'>" + list[i] + "</button> ");
                                        }
                                        else {
                                            //  alert("hi1");
                                            var minHeight = $("#divCSCurrentChoiceEdit").find(".btns").first().css("min-Height");
                                            var minWidth = $("#divCSCurrentChoiceEdit").find(".btns").first().css("min-Width");
                                            var firstBtn = $("#divCSCurrentChoiceEdit").find(".btns").last().find(".btn-default").first().html();
                                            $("#divCSCurrentChoiceEdit").find(".btns").last().find(".btn-default").first().next().remove();
                                            //  var nextBtn=
                                            $("#divCSCurrentChoiceEdit").find(".btns").last().append("<button type='button' class='btn-default active' id='" + list[i] + "'>" + list[i] + "</button> ");
                                            $("#divCSCurrentChoiceEdit").find(".btns").last().after("<div class='btns' style='min-Height:" + minHeight + "; min-Width:50%;max-Width:50%'><button type='button' class='btn-default' id='" + "Other" + "'>" + "Other" + "</button> </div>");
                                        }
                                      //  CurrentCSEditButtonClick();
                                    }
                    ...
                    $("#divCSFutureChoiceEdit").find(".btn-default").each(function () {
                     ...
                     var activeLength = $("#divCSFutureChoiceEdit").find(".active").length;
                            if (activeLength == 0) {
                                $("#divCSFutureContentEdit").addClass("blur-div");
                                $("#divCSFutureChoiceEdit").find(".btn-default").attr("disabled", "disabled");
                                for (var i = 0; i < list.length; i++) {
                                    $("#divCSCurrentChoiceEdit").find(".btn-default").each(function () {
                                        var btnValue = $.trim($(this).html());
                                        if (btnValue == $.trim(list[i])) {
                                            $(this).addClass("active");
                                        }
                                    });
                                }
                                ...
                                $("#divCSCurrentContentEdit").addClass("blur-div");
                                $("#divCSCurrentChoiceEdit").find(".btn-default").attr("disabled", "disabled");
                            }
                    //$("#divCSCurrentChoiceEdit").find(".btn-default").each(function () {
                    //    for (var i = 0; i < list.length; i++) {
                    //        if ($.trim($(this).text()) == $.trim(list[i])) {
        ...
        $("#btnOk").on("click", function () {
            ...
            if (questionType == "2") {
                ...
                InsertCustomerPriorityChoiceDetails($("#hidCustId").val(), $("#hidPriorityId").val(), $("#hidQuestionType").val(), answer,-1);
            }
    ...
    <script type="text/javascript">
            ...
            $("#btnNextScore").on("click", function () {
                ...
                if (title.indexOf("Current") > -1) {
                   ...
                   // alert(currentPriority);
                    currentPriority =parseInt(currentPriority)+ 1;
                    var priorityId;
                    var priorityName;
        ...
        function InsertValueMapScore(QuestionTypeId) {
            $.ajax({
                type: "POST",
                url: "ValueMap.aspx/InsertValueMapScore",
        ...
        function BindValueMapScore(questionTypeID) {
            ...
            $.ajax({
                type: "POST",
                url: "ValueMap.aspx/GetValueMapScore",
    ...
    <script type="text/javascript">
        function ToggleVMReview() {
            ...
            if ($("#divEditPriority").css("display") == "none" && $("#btnVmReview").css("display") != "none") {
               ...
               // $("#create_pdf").css("display","none")
                ...
                $("#btnVmReview").css("display", "none");
                if( $("#divPriorityOverView").css("display")!="none")
                    //$("#create_pdf").css("display", "")
                    $("#create_pdf").css("display", "")
                else
                    $("#create_pdf").css("display", "none")
            }
            if ( $("#divPriorityOverView").css("display")=="none") {
                $("#divValueGapTitle,#divValueGapContent,#lblValueMapTitle,#create_pdf").css("display", "none");
            }
            else {
                //$("#divValueGapTitle,#divValueGapContent,#lblValueMapTitle,#create_pdf").css("display", "");
                $("#divValueGapTitle,#lblValueMapTitle").css("display", "");
            }
        }
        function ToggleValueGap() {
        ...
        $(function () {
            ...
            $("#btnVmReview").on("click", function () {
                ...
                if (btnText.indexOf("Finish") > -1) {
                  //  alert($(this).text());
                    window.open($("#hidVMOCustomerUrl").val(), "_blank");
                   // alert($("#hidVMOCustomerUrl").val());
                return false;
                }
                ...
                $("#divValueGapTitle,#divValueGapContent,#lblValueMapTitle,#create_pdf").css("display", "none");
               // alert($("#hidValueMapStatus").val());
               // alert($("#hidValueMapQuestionDisplay").val());
        ...
        function DeleteAllCustomerPriority() {
            $.ajax({
                type: "POST",
                url: "ValueMap.aspx/DeleteAllCustomerPriority",
    ...
    <script type="text/javascript">
		...
		function maxHeightPrioritySquares(divId) {
            var maxHeight = Math.max.apply(null, $(document).find("." + divId).map(function () {
                return $(this).find("div").height();
            }).get());

           // alert(maxHeight);
            $(document).find("." + divId).css("height", maxHeight);
           // $(document).find("." + divId).css("min-height", maxHeight);
        }
       setTimeout(function(){maxHeightPrioritySquares("square")},1000);
        $(function () {
            $("#pnlScore").find(".slider-container").find(".scale").find("span:eq(3)").find("ins").html("+5");
            $("#pnlScore").find(".slider-container").find(".scale").find("span:eq(4)").find("ins").html("+10");
            $("#pnlScore").find(".slider-container").find(".scale").find("span:eq(0)").css("left","-2%");
            $("#btnValueGapTitle").on("click", function () {
                //return false;
                if ($("#divValueGapContent").css("display") == "none") {
                    $("#divValueGapTitle,#divValueGapContent,#lblValueMapTitle").css("display", "");
                  //  $('#valueGapModal').modal('show');
                }
                else {
                    $("#divValueGapContent").css("display", "none");
                }

            })
        })
    </script>
     <script type="text/javascript"  src="https://kendo.cdn.telerik.com/2017.3.1026/js/kendo.all.min.js"></script>
    <script type="text/javascript">
        (function () {
	        var
                form = $('#divPriorityOverView'),
                cache_width = form.width(),
                a4 = [1200, 100];  // for a4 size paper width and height
	        // alert(cache_width);
	        $('#create_pdf').on('click', function () {
	           var drawing = kendo.drawing;
                ...
                $("#divPrintCustomerInfo").css("display", "");
                //return false;
               // ShowLoader();
                var elementToExport = $("#divPriorityOverView");
                // kendo.drawing.drawDOM
                kendo.drawing.drawDOM(elementToExport,{ avoidLinks: true})
                .then(function (group) {
                    $("#trTitle").css("display", "none");
                    $("#divPrintCustomerInfo").css("display", "none");
	        ...
	        function createPDF() {
	            getCanvas().then(function (canvas) {
	                ...
	                doc.save('valuemap.pdf');
	                form.width(cache_width);
	                //  form.width(("950")).css('max-width', '950').css("background", "transperent !important");
	            });
	        ...
	        function getCanvas() {
	            form.width(("950")).css('max-width', '950');
	            //   form.height("300");
