...
Public Class ValueMap
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Dim lblSecondaryName As String = Convert.ToString(dt1.Rows(0)("SecondaryFirstName")) & " " & Convert.ToString(dt1.Rows(0)("SecondaryLastName"))
            If Not String.IsNullOrEmpty(lblSecondaryName.Trim()) Then
                lblPrintCustomerName.Text = lblPrintCustomerName.Text & " and " & lblSecondaryName
            End If
            ...
            If ds.Tables(0).Rows.Count = 0 Then
                ...
                btnVmReview.Attributes.Add("disabled", "disabled")
            Else
                'create_pdf.Style.Add("display", "none")
                ...
                If valueMapStatus = "Completed" Then
                    btnVmReview.InnerText = " VM Review "
                End If
    ...
    <System.Web.Services.WebMethod()> Public Shared Function InsertCustomerPriorityChoiceDetails(ByVal CustId As String, ByVal PriorityId As String, ByVal QuestionTypeId As String, ByVal Answer As String, ByVal WWDC As Integer) As String
        ...
        objCustomerProcessor.GetContactInfoByUser(Config.UserId, CustId, dtCustomer)
        ...
        If vmstatus.ToLower() = "completed" Then
            ...
            result1 = objToDoProcessor.InsertToDoDetails("Send Evaluation Letter", description, DateTime.Now, 1, Config.UserId, CustId)
            If result1 > 0 Then
    ...
    Public Sub LoadVMOCustomer()
        ...
        body = body.Replace("ValueMapCustomer.aspx", "ValueMapOCustomerNew.aspx")
        body = body & "&realtor=1"
        hidVMOCustomerUrl.Value = body
    End Sub
End Class
