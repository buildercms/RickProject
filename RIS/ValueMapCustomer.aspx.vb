    ...
    Protected Sub btnRealtorEmail_Click(sender As Object, e As EventArgs)
        ...
        If Not valueMapStatus.ToLower <> "completed" Then
            ...
            If success = True Then
                Dim objPriorityProcessor As New PriorityProcessor()
                UserProcessor.InsertUserActivity("value map", "was submitted to ", Request.QueryString("cid"), userId)
                objCustomerProcessor.UpdateVMCustomer(Request.QueryString("cid"))
            End If
        End If
