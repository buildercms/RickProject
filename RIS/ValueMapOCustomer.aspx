<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteCustomer.Master" CodeBehind="ValueMapOCustomer.aspx.vb" Inherits="RIS.ValueMapOCustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" ClientIDMode="Static">
    ...
    <asp:Button id="btnRealtorEmail" ClientIDMode="Static" runat="server" OnClick="btnRealtorEmail_Click" style="display:none;" />
    ...
    font-size: 20px;"></p>
        ...
        <div class="row" id="divVerifyEmail" runat="server" style="top: 270px!important; position: absolute; overflow-x: hidden; width: 945px;display:none;">
            <div class="col-md-2"></div>
            <div class="col-md-10">
  ...
  <div class="modal-dialog">
    ...
    <script type="text/javascript">
            ...
            $("#btnPreviousFuture").click(function () {
                if (currentPriority == 1) {
                   ...
                   // $("#divCSBenefit").show();
                    ...
                    $("#hidPriorityId").val(priorityId);
                    $("#hidPriorityName").val(priorityName);
                    $("#btnPreviousImpact").trigger("click");
                    //GetCustomerPriorityBenefit($("#hidCustId").val(), $("#hidPriorityId").val(), 4);
        ...
        function BindAnswer(questionTypeId, lblId) {
            ...
            $.ajax({
                url: "ValueMapOCustomer.aspx/GetValueMapChoicesByQuestionId",
                type: "POST",
                dataType: "json",
                data: dataValue,
    ...
    <script type="text/javascript">
        ...
        function InsertCustomerPriorityChoices() {
            ...
            $.ajax({
                url: "ValueMapOCustomer.aspx/InsertCustomerPriorityChoices",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
         ...
         function UpdateCustomerPriorityChoiceRank() {
            var dataValue = '{CustId: "' + $("#hidCustId").val() + '", Priority: "' + $("#hidPriority").val() + '"}';
            $.ajax({
                url: "ValueMapOCustomer.aspx/UpdateCustomerPriorityChoiceRank",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function GetCSIdeal() {
            ...
            $.ajax({
                url: "ValueMapOCustomer.aspx/GetCustomerPriorityIdeal",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
 ...
 function InsertCustomerPriorityChoiceDetails(custId, priorityId, questionType, answer,wwdc) {
            ...
            $.ajax({
                url: "ValueMapOCustomer.aspx/InsertCustomerPriorityChoiceDetails",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function GetCSCurrent(custId, priorityId, questionType) {
            ...
            $.ajax({
                url: "ValueMapOCustomer.aspx/GetCustomerPriorityCurrent",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function BindCustomerPriorityImpact(dataValue) {
            //alert("hi");
             $.ajax({
                url: "ValueMapOCustomer.aspx/GetCustomerPriorityImpact",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function GetCustomerPriorityBenefit(custId, priorityId, questionType) {
            var dataValue = '{CustId: "' + custId + '", PriorityId: "' + priorityId + '",QuestionTypeId: "' + questionType + '"}';
            $.ajax({
                url: "ValueMapOCustomer.aspx/GetCustomerPriorityBenefit",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function GetCustomerFuture() {
            ...
            $.ajax({
                url: "ValueMapOCustomer.aspx/GetCustomerFuture",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
         ...
         function inArray(item,arr)
{
    ...
    return false;
        ...
        function GetSelectedPriorityChoices(custId, priorityId, questionType) {
            ...
            $.ajax({
                url: "ValueMapOCustomer.aspx/GetCustomerPriorityChoices",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
    ...
    <script type="text/javascript">
        ...
        $(".fsdesc").on("click", function () {
            ...
            $.ajax({
                url: "ValueMapOCustomer.aspx/GetCustomerFutureEdit",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        $(".fsimpact").on("click", function () {
            ...
            //  alertDialog(list.length);
            $.ajax({
                url: "ValueMapOCustomer.aspx/GetCustomerFutureImpactEdit",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        $(".csimpact").on("click", function () {
            ...
            //  alertDialog(list.length);
            $.ajax({
                url: "ValueMapOCustomer.aspx/GetCustomerCSImpactEdit",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        $(".csdesc").on("click", function () {
            ...
            //  alertDialog(list.length);
            $.ajax({
                url: "ValueMapOCustomer.aspx/GetCustomerPriorityCurrentEdit",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#btnNextScore").on("click", function () {
                ...
                if (currentPriority > 3) {
                        ...
                        //window.location.reload();
                        //var URL = window.location.href;
                        window.location.href = "ValueMap.aspx?cid="+$("#hidCustId").val();
                        // $("#btnRealtorEmail").trigger("click");
                    return false;
        ...
        function InsertValueMapScore(QuestionTypeId) {
            $.ajax({
                type: "POST",
                url: "ValueMapOCustomer.aspx/InsertValueMapScore",
        ...
        function BindValueMapScore(questionTypeID) {
            ...
            $.ajax({
                type: "POST",
                url: "ValueMapOCustomer.aspx/GetValueMapScore",
    ...
    <script type="text/javascript">
        ...
        function DeleteAllCustomerPriority() {
            $.ajax({
                type: "POST",
                url: "ValueMapOCustomer.aspx/DeleteAllCustomerPriority",
    ...
    <script type="text/javascript">
        ...
        function redirectValueMap() {
             self.close();
            window.opener.location.reload(false);
           
            //alert("redirectValueMap");
        }
    </script>
    <script type="text/javascript">
        $(function () {
