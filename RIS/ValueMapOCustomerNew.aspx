<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteCustomer.Master" CodeBehind="ValueMapOCustomerNew.aspx.vb" Inherits="RIS.ValueMapOCustomerNew" %>
        ...
        $(function () {
            ...
            $("#btnNextRank").click(function () {
               ...
               // $("#divCSFuture").show();
                ...
                $("#divCSImpact").show();
                    $("#divCSImpact").find(".priority-title").html($("#hidPriorityName").val());
                }
                else {
                     BindPriorityName();
