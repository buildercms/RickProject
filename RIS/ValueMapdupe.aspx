<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ValueMapdupe.aspx.vb" Inherits="RIS.ValueMapdupe" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" ClientIDMode="Static">
    ...
    <div class="right" id='maincontent'>
        ...
        <div class="row queries my-3">
            ...
            <div class='col-md-5' style="padding: 10px;">
               <button class="btn float-right align-text-bottom font-weight-bold px-3" style="" id="btnVmReview" runat="server" type="button">&nbsp;VM Review&nbsp;</button>&nbsp;&nbsp;
            </div>
        </div>
 ...
 <div class="col-md-12 text-center " style="font-size:24px" >Personal Value Map Created For:&nbsp; <asp:Label ID="lblPrintCustomerName" runat="server" Font-Size="24px">Customer Name</asp:Label></div>
  ...
  <div class="modal-dialog">
    ...
    <script type="text/javascript">
        ...
        function BindAnswer(questionTypeId, lblId) {
            ...
            $.ajax({
                url: "ValueMapdupe.aspx/GetValueMapChoicesByQuestionId",
                type: "POST",
                dataType: "json",
                data: dataValue,
    ...
    <script type="text/javascript">
        ...
        function InsertCustomerPriorityChoices() {
            ...
            $.ajax({
                url: "ValueMapdupe.aspx/InsertCustomerPriorityChoices",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function UpdateCustomerPriorityChoiceRank() {
            var dataValue = '{CustId: "' + $("#hidCustId").val() + '", Priority: "' + $("#hidPriority").val() + '"}';
            $.ajax({
                url: "ValueMapdupe.aspx/UpdateCustomerPriorityChoiceRank",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function GetCSIdeal() {
            ...
            $.ajax({
                url: "ValueMapdupe.aspx/GetCustomerPriorityIdeal",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function InsertCustomerPriorityChoiceDetails(custId, priorityId, questionType, answer,wwdc) {
            ...
            $.ajax({
                url: "ValueMapdupe.aspx/InsertCustomerPriorityChoiceDetails",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function GetCSCurrent(custId, priorityId, questionType) {
            ...
            $.ajax({
                url: "ValueMapdupe.aspx/GetCustomerPriorityCurrent",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function GetCustomerPriorityImpact(custId, priorityId, questionType) {
            var dataValue = '{CustId: "' + custId + '", PriorityId: "' + priorityId + '",QuestionTypeId: "' + questionType + '"}';
            $.ajax({
                url: "ValueMapdupe.aspx/GetCustomerPriorityImpact",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function GetCustomerPriorityBenefit(custId, priorityId, questionType) {
            var dataValue = '{CustId: "' + custId + '", PriorityId: "' + priorityId + '",QuestionTypeId: "' + questionType + '"}';
            $.ajax({
                url: "ValueMapdupe.aspx/GetCustomerPriorityBenefit",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function GetCustomerFuture() {
            ...
            $.ajax({
                url: "ValueMapdupe.aspx/GetCustomerFuture",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        function inArray(item,arr)
{
    ...
    return false;
        ...
        function GetSelectedPriorityChoices(custId, priorityId, questionType) {
            ...
            $.ajax({
                url: "ValueMapdupe.aspx/GetCustomerPriorityChoices",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
    ...
    <script type="text/javascript">
        ...
        $(".fsdesc").on("click", function () {
            ...
            $.ajax({
                url: "ValueMapdupe.aspx/GetCustomerFutureEdit",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        $(".fsimpact").on("click", function () {
            ...
            //  alertDialog(list.length);
            $.ajax({
                url: "ValueMapdupe.aspx/GetCustomerFutureImpactEdit",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        $(".csimpact").on("click", function () {
            ...
            //  alertDialog(list.length);
            $.ajax({
                url: "ValueMapdupe.aspx/GetCustomerCSImpactEdit",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
        ...
        $(".csdesc").on("click", function () {
            ...
            //  alertDialog(list.length);
            $.ajax({
                url: "ValueMapdupe.aspx/GetCustomerPriorityCurrentEdit",
                type: "POST",
                dataType: "json",
                data: dataValue,
                contentType: "application/json; charset=utf-8",
                                ...
                                for (var i = 0; i < list.length; i++) {
                                    if (inArray(list[i], btnArray) == false) {
                                        ...
                                        if (btnCount % 2 == 0) {
                                            ...
                                            //  var nextBtn=
                                            $("#divCSCurrentChoiceEdit").find(".btns").last().append("<button type='button' class='btn-default active' id='" + answers[i] + "'>" + answers[i] + "</button> ");
    ...
    <script type="text/javascript">
        ...
        function InsertValueMapScore(QuestionTypeId) {
            $.ajax({
                type: "POST",
                url: "ValueMapdupe.aspx/InsertValueMapScore",
        ...
        function BindValueMapScore(questionTypeID) {
            ...
            $.ajax({
                type: "POST",
                url: "ValueMapdupe.aspx/GetValueMapScore",
    ...
    <script type="text/javascript">
        ...
        function DeleteAllCustomerPriority() {
            $.ajax({
                type: "POST",
                url: "ValueMapdupe.aspx/DeleteAllCustomerPriority",
